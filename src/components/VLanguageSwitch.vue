<template>
  <ClientOnly>
    <UButton color="gray" variant="ghost" aria-label="Theme" @click="toggleLocale">
      <svg
        v-if="locale === LocaleKey.ZH_CN"
      ...
      <svg v-else xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 48 48">
        <g fill="none" :stroke="colorMode === 'dark' ? '#AAAAAA' : '#555555'" stroke-linecap="round" stroke-width="4">
          <rect
            width="36"
            height="36"
            x="6"
