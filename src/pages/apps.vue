<template>
  <div class="flex h-full flex-col">
    <div class="relative flex grow flex-col overflow-auto bg-gray-100">
      <div
        class="sticky left-0 right-0 top-0 z-20 flex h-14 shrink-0 grow-0 basis-auto border-b border-gray-200 bg-gray-100"
      >
        <div class="flex flex-1 items-center justify-between px-4">
          ...
          <div class="flex items-center">
            ...
            >
              <a href="/apps">
                <div class="text-primary-600 undefined flex h-7 cursor-pointer items-center rounded-[10px] px-2.5">
                  <div class="mr-2">
                    <svg
                      width="17"
                      height="16"
      ...
      <div class="flex shrink-0 grow flex-col overflow-auto bg-gray-100">
        <nav
          class="grid shrink-0 grow grid-cols-1 content-start gap-4 px-12 pt-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4"
        >
          <a class="list_listItem__SRP12 list_newItemCard__ukqTd">
            <div class="list_listItemTitle__lEzu5">
              <span class="list_newItemIcon__ZjoUj"><span class="list_newItemIconImage__XKqk4 list_newItemIconAdd__Gr3KR" /></span>
              <div class="list_listItemHeading__uMQ9j list_newItemCardHeading__7v0UD">创建应用</div>
            </div> </a><a class="list_listItem__SRP12" href="/app/e29d4e9a-f38e-4e32-9c92-5a55b39c1c46/overview">
            <div class="list_listItemTitle__lEzu5">
              <span class="style_appIcon__G5ePF style_small__S2FSo">
                <em-emoji id="🤖"><span
                ...
                >🤖</span></span></em-emoji></span>
              <div class="list_listItemHeading__uMQ9j">
                <div class="list_listItemHeadingContent__T0S2O">押韵助手</div>
              </div>
              <div class="relative" data-headlessui-state="">
                <div>
                  <button
                    id="headlessui-popover-button-:r1:"
                    class="style_popupBtn__l6XBJ list_actionIconWrapper__qm_b7 group !bg-transparent bg-gray-100"
                    type="button"
                    aria-expanded="false"
                    data-headlessui-state=""
                  >
                    <div class="style_actionIcon__LUiL_ style_commonIcon__Hb_r_" />
                  </button>
                </div>
              </div>
              <div
            ...
            <div class="list_listItemDescription__QZ0gA" />
            <div class="list_listItemFooter__7fRR_">
              <span class="flex h-6 w-fit items-center gap-1 rounded border border-gray-100 px-2 text-xs text-gray-500"><span class="list_listItemFooterIcon__wli_8 list_solidCompletionIcon__Nugxc" />文本生成型</span>
            </div>
          </a>
        </nav>
        <div class="h-0" />
        <footer class="shrink-0 grow-0 px-12 py-6">
          <h3 class="text-gradient text-xl font-semibold leading-tight">
            参与社区
          </h3>
          <p class="mt-1 text-sm font-normal leading-tight text-gray-700">
            与团队成员、贡献者和开发者在不同频道中交流
          </p>
          <div class="mt-3 flex items-center gap-2">
            <a
              class="list_socialMediaLink__8cg0K"
              target="_blank"
              href="https://github.com/langgenius/dify"
            ><span class="list_socialMediaIcon__ZJ51k list_githubIcon__7fOI3" /></a><a
              class="list_socialMediaLink__8cg0K"
              target="_blank"
              href="https://discord.gg/FngNHpbcY7"
            ><span class="list_socialMediaIcon__ZJ51k list_discordIcon__7Flua" /></a>
          </div>
        </footer>
      </div>
    </div>
